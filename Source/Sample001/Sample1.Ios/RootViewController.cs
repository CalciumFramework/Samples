...
namespace Sample1
{
	public partial class RootViewController : UIViewController
	{
			...
			UIInterfaceOrientation orientation)
		{
			...
			var index = ModelController.IndexOf((DataViewController)currentViewController);
			if (index == 0 || index % 2 == 0)
			{
				UIViewController nextViewController =
					ModelController.GetNextViewController(pageViewController, currentViewController);
				viewControllers = new[] {currentViewController, nextViewController};
			}
			else
			{
				UIViewController previousViewController =
					ModelController.GetPreviousViewController(pageViewController, currentViewController);
